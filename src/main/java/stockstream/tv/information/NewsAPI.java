...
public class NewsAPI {
    ...
    @PostConstruct
    public void init() {
        this.scheduler.scheduleJob(this::refreshInfo, 0, 3, TimeUnit.MINUTES);
    }
    ...
    private void refreshPlatform(final String platform, final String sortOrder) {
        ...
        final Optional<HTTPResult> httpResultOptional = this.httpClient.executeHTTPGetRequest(httpQuery);
        ...
        for (final Object article : articles) {
            ...
            this.pubSub.publishClassType(InfoMessage.class, new InfoMessage(author, info, messageTimestamp, platform, storyUrl, imageUrl));
        }
    }
